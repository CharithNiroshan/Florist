...
<body>
    <div class="header">
        <img src="images/euroflora-logo.png" alt="" width="50%">
    </div>
    <div class="content">
        <p>
        ...
        <form action="">
            ...
            <input type="tel" pattern="[0-9]{9}" placeholder="Mobile Number" id="mobile" required>
            <br><br>
            <label for="ordercode">Order Code </label>
            <input type="text" name="ordercode" id="ordercode" class="input" placeholder="Enter the code received by email if available">
            <br><br>
            <div class="messagediv">
                <label for="message" id="messagelabel">Message* </label>
                <textarea name="message" id="message" placeholder="Describe your request accurately to receive better info." required></textarea>    
            </div>
            <br>
